...
description: Reference codebase for Frontend. Use this skill when you need to understand the structure, implementation patterns, or code details of the Frontend project.
---

# Frontend Codebase Reference

44 files | 4912 lines | 39634 tokens
