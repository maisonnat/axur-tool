...
description: Reference codebase for Backend. Use this skill when you need to understand the structure, implementation patterns, or code details of the Backend project.
---

# Backend Codebase Reference

32 files | 3090 lines | 23095 tokens
