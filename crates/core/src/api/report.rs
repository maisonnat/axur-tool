    ...
    pub fn demo() -> Self {
        PocReportData {
            ...
            incidents_by_type: vec![
                ...
                IncidentTypeCount {
                    incident_type: "brand-abuse".to_string(),
                    detections: 840,
                    incidents: 42,
                },
                IncidentTypeCount {
                    incident_type: "fake-social".to_string(),
                    detections: 320,
                    incidents: 15,
                },
            ],
            takedown_resolved: 450,
            takedown_pending: 12,
            takedown_aborted: 5,
            takedown_unresolved: 8,
            ...
            roi_metrics: OperationalMetrics {
                hours_saved_total: 1250.0,
                hours_saved_validation: 450.0,
                hours_saved_credentials: 300.0,
                hours_saved_takedowns: 500.0,
                hours_saved_secrets: 50.0,
                analysts_equivalent_monthly: 8.5,
                person_days_saved: 156.0,
                avg_response_minutes: 12.0,
                median_response_time: "12 min".to_string(),
                median_threat_exposure: "3.5 horas".to_string(),
                takedown_success_rate: 98.2,
                tickets_processed: 2450,
                credentials_monitored: 5120,
                secrets_detected: 45,
                takedowns_completed: 450,
                threats_detected: 2800,
                takedown_resolution_rate: 98.0,
                response_speed_multiplier: 12.0,
