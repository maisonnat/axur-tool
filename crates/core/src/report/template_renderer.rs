...
pub fn get_mock_placeholder_values() -> HashMap<String, String> {
    ...
    values.insert(
        ...
        format!(r#"<span style="font-size:48px;font-weight:bold;color:#6366F1;">247</span>"#),
    );
    values.insert(
        "total_takedowns".to_string(),
        format!(r#"<span style="font-size:48px;font-weight:bold;color:#10B981;">189</span>"#),
    );
    values.insert(
        "avg_takedown_time".to_string(),
        format!(r#"<span style="font-size:36px;color:#F59E0B;">4.2h</span>"#),
    );

    // Risk Score
    values.insert("risk_score_gauge".to_string(), format!(
    ...
    // Charts (simplified)
    values.insert("incidents_chart".to_string(), format!(
    ...
    values.insert("threat_distribution_pie".to_string(), format!(
    ...
    // Tables
    values.insert("top_threats_table".to_string(), format!(
    ...
    values.insert("takedowns_table".to_string(), format!(
        r#"<table style="width:100%;border-collapse:collapse;font-size:14px;">
            <thead><tr style="border-bottom:1px solid #334155;">
    ...
    // Media
    values.insert("evidence_gallery".to_string(), format!(
        r#"<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:10px;">
    ...
    // AI Analysis
    values.insert("ai_executive_summary".to_string(), format!(
        r#"<div style="padding:20px;background:linear-gradient(135deg,#6366F120,#EC489920);border-radius:8px;border-left:3px solid #6366F1;">
    ...
    values.insert("campaign_summary".to_string(), format!(
        r#"<div style="padding:15px;background:#1E293B;border-radius:8px;">
